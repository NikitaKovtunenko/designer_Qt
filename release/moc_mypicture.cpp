...
QT_MOC_LITERAL(10, 11), // "wheelsignal"
QT_MOC_LITERAL(22, 0), // ""
QT_MOC_LITERAL(23, 12), // "scaleChanged"
QT_MOC_LITERAL(36, 1) // "a"

    },
    "MyPicture\0wheelsignal\0\0scaleChanged\0"
    "a"
};
...
void MyPicture::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->wheelsignal((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        ...
        {
            using _t = void (MyPicture::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyPicture::wheelsignal)) {
                *result = 0;
                return;
            }
        }
...
, QtPrivate::TypeAndForceComplete<MyPicture, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<int, std::false_type>
...
// SIGNAL 0
void MyPicture::wheelsignal(int _t1)
{
